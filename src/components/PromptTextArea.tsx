...
export default function PromptTextArea({ selectedItems }: Props) {
  ...
  return (
    <>
      <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your prompt:</label>
      <textarea
        id="message"
        rows={5}
